...
`timescale 1 ps / 1 ps
module hps_fgpa_mm_interconnect_0 (
	...
	wire  [123:0] ram_s1_agent_rf_source_data;                       // ram_s1_agent:rf_source_data -> ram_s1_agent_rsp_fifo:in_data
	...
	wire  [123:0] ram_s1_agent_rsp_fifo_out_data;                    // ram_s1_agent_rsp_fifo:out_data -> ram_s1_agent:rf_sink_data
	...
	wire  [122:0] ram_s1_agent_rp_data;                              // ram_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [122:0] ram_s1_burst_adapter_source0_data;                 // ram_s1_burst_adapter:source0_data -> ram_s1_agent:cp_data
	...
	wire  [122:0] router_002_src_data;                               // router_002:src_data -> ram_s1_rsp_width_adapter:in_data
	...
	wire  [158:0] ram_s1_rsp_width_adapter_src_data;                 // ram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [158:0] cmd_mux_src_data;                                  // cmd_mux:src_data -> ram_s1_cmd_width_adapter:in_data
	...
	wire  [122:0] ram_s1_cmd_width_adapter_src_data;                 // ram_s1_cmd_width_adapter:out_data -> ram_s1_burst_adapter:sink0_data
	...
	hps_fgpa_mm_interconnect_0_router router (
	...
	hps_fgpa_mm_interconnect_0_router router_001 (
	...
	hps_fgpa_mm_interconnect_0_router_002 router_002 (
	...
	hps_fgpa_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (ram_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (ram_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_fgpa_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
